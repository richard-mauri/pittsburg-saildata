...
(function(){
  ...
  fetch("/assets/marine_places.json?build=v241", {headers:{"Accept":"application/json"}, cache:"no-store"})
  ...
  map.getPane("windBarbPane").style.zIndex = 434;
